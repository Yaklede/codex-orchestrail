...
const lowModels = Object.fromEntries(['scout','builder','reviewer','expert'].map(role => [role, { effort: 'low' }]));
execFileSync(process.execPath, [runtime, 'setup', '--project', root], { input: JSON.stringify({ models: lowModels }) });
